...
const Project = async ({ params: { id } }: { params: { id: string } }) => {
    ...
    const projectDetails = result?.projects
        ...
        <Modal>
                ...
                <div className="flex-1 flex items-start gap-5 w-full max-xs:flex-col">
                    ...
                    <div className="flex-1 flexStart flex-col gap-1">
                        ...
                        <div className="user-info">
                            ...
                            <Link href={`/?category=${projectDetails?.catgeory}`} className="text-primary-purple font-semibold"> 
                                {projectDetails?.catgeory}
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <section className="flexCenter flex-col mt-20">
                ...
                <div className="flex flex-wrap mt-5 gap-5">
                    ...
                    <Image src="/dot.svg" width={4} height={4} alt="dot" />
                    <Link href={projectDetails?.liveProjectUrl as string} target="_blank" rel="noreferrer" className="flexCenter gap-2 tex-sm font-medium text-primary-purple">
